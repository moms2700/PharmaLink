...
export default function PharmaLink() {
  ...
  const Hero = () => (
    <section style={{
      background: 'linear-gradient(135deg,#0066CC,#00CC66)', color: '#fff',
      ...
      <div style={{ maxWidth: 1152, margin: '0 auto' }}>
        ...
        <p style={{ opacity: .9, marginBottom: 24 }}>
        ...
        <div style={{ maxWidth: 640, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 16, marginTop: 24 }}>
            {[
              { num: '40+', title: 'Médicaments' },
              { num: '10', title: 'Pharmacies' },
              { num: '2h', title: 'Réservation' },
            ].map((s, i) => (
              <div key={i} style={{
                background: 'rgba(255,255,255,0.15)', padding: 16, borderRadius: 8
              }}>
  ...
  const medications = [
    'Doliprane 1000mg','Paracétamol 500mg','Ibuprofène 400mg','Amoxicilline 1g',
    'Augmentin 1g','Ventoline Spray','Smecta','Gaviscon','Spasfon','Motilium',
  ];
          ...
          <section style={{ padding: '40px 24px' }}>
            <div style={{ maxWidth: 1152, margin: '0 auto' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(200px,1fr))', gap: 12 }}>
                {medications.map((m, i) => (
                  <div key={i} style={{
                    background: '#fff', border: '1px solid #e5e7eb', boxShadow: '0 1px 2px rgba(0,0,0,0.06)',
            ...
            <div style={{ maxWidth: 1152, margin: '0 auto' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(280px,1fr))', gap: 12 }}>
                {pharmacies.map((p) => (
                  <div key={p.id} style={{
                    background: '#fff', border: '1px solid #e5e7eb', boxShadow: '0 1px 2px rgba(0,0,0,0.06)',
                    borderLeft: '4px solid #0066CC', borderRadius: 8, padding: 16
                  }}>
            ...
            <div style={{ maxWidth: 1152, margin: '0 auto' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(300px,1fr))', gap: 12 }}>
                {searchResults.map((r) => (
                  <div key={r.id} style={{
                    background: '#fff', border: '1px solid #e5e7eb', boxShadow: '0 1px 2px rgba(0,0,0,0.06)',
                    borderLeft: '4px solid #22c55e', borderRadius: 8, padding: 16
                  }}>
                    ...
                    <button style={{
                      ...
                      background: '#0066CC', color: '#fff', fontWeight: 700, cursor: 'pointer'
                    }}>
                      Réserver
                    </button>
                  </div>
